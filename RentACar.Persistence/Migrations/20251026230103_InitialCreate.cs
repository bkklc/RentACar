        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLicenseDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatCapacities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatCapacityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BodyTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ColorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoorTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    WheelDriveTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModelYearId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cars_DoorTypes_DoorTypeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cars_SeatCapacities_SeatCapacityId",
                        column: x => x.SeatCapacityId,
                        principalTable: "SeatCapacities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cars_Series_SerieId",
                        column: x => x.SerieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cars_SeatCapacityId",
                table: "Cars",
                column: "SeatCapacityId");

            migrationBuilder.CreateIndex(
                name: "IX_Cars_SerieId",
                table: "Cars",
                column: "SerieId");
